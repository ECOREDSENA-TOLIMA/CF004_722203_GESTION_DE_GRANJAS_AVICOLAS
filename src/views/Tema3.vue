...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .d-flex.flex-wrap.mb-5
      ...
      img.mb-4.mb-xl-0.col-xl-4.mx-auto.order-1.order-xl-2(src="@/assets/curso/temas/tema3/img-43.png" data-aos="fade-left" style="max-width: 400px")
    ...
    p.mb-4(data-aos="fade-right") La ley de la demanda y de la oferta se unen para dar cabida a esta teoría; la primera apunta a una relación inversa, donde a menor sea el precio de un bien o servicio, mayor será la demanda, es decir, la intención de los consumidores de adquirirlo. Por otra parte, la ley de la oferta describe una relación directa, donde a mayor precio del producto, mayor será la intención de los productores de ofrecerlo.
    ...
    p(data-aos="fade-right") Finalmente, es indispensable conocer qué se puede hacer de manera permanente para alcanzar el objetivo de producción y el porcentaje de ventas al final del proceso productivo.
